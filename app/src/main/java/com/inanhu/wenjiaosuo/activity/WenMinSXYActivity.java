 ...
 */
public class WenMinSXYActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BGAOnRVItemClickListener {
    ...
    private void getData() {
        ...
        params.addFormDataPart(Constant.RequestKey.CID, "12"); // 不传分类列表就获取全类别的
...
//        params.addFormDataPart(Constant.RequestKey.PAGE, "1");
    ...
    public void onRVItemClick(ViewGroup viewGroup, View view, int position) {
        if (!TextUtils.isEmpty(mAdapter.getItem(position).getAurl())) {
            ...
            intent.setClass(WenMinSXYActivity.this, WebviewActivity.class);
