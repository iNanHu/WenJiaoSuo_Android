 ...
 */
public class LevelOneFansFragment extends BaseV4Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate, BGAOnRVItemClickListener {
    ...
    private void refreshData() {
        if (isNetConnected()) {
            ...
            params.addFormDataPart(Constant.RequestKey.FANS_LEVEL, 1);
